...
#ifdef __BLOCKS__
typedef struct avdecc_local_entity_controller_block_delegate_s
{
	/* **** Global notifications **** */
	/** Called when a fatal error on the transport layer occured. */
	void(^ onTransportError)(LA_AVDECC_LOCAL_ENTITY_HANDLE const /*handle*/);

	/* Discovery Protocol (ADP) */
	/** Called when a new entity was discovered on the network (either local or remote). */
	void(^ onEntityOnline)(LA_AVDECC_LOCAL_ENTITY_HANDLE const /*handle*/, avdecc_unique_identifier_t const /*entityID*/, avdecc_entity_cp const /*entity*/);
	/** Called when an already discovered entity updated its discovery (ADP) information. */
	void(^ onEntityUpdate)(LA_AVDECC_LOCAL_ENTITY_HANDLE const /*handle*/, avdecc_unique_identifier_t const /*entityID*/, avdecc_entity_cp const /*entity*/);
	/** Called when an already discovered entity went offline or timed out (either local or remote). */
	void(^ onEntityOffline)(LA_AVDECC_LOCAL_ENTITY_HANDLE const /*handle*/, avdecc_unique_identifier_t const /*entityID*/);

	/* Connection Management Protocol sniffed messages (ACMP) (not triggered for our own commands even though ACMP messages are broadcasted, the command's 'result' method will be called in that case) */
	/** Called when a controller connect request has been sniffed on the network. */
	void(^ onControllerConnectResponseSniffed)(LA_AVDECC_LOCAL_ENTITY_HANDLE const /*handle*/, avdecc_entity_model_stream_identification_cp const /*talkerStream*/, avdecc_entity_model_stream_identification_cp const /*listenerStream*/, unsigned short const /*connectionCount*/, avdecc_entity_connection_flags_t const /*flags*/, avdecc_local_entity_control_status_t const /*status*/);
	/** Called when a controller disconnect request has been sniffed on the network. */
	void(^ onControllerDisconnectResponseSniffed)(LA_AVDECC_LOCAL_ENTITY_HANDLE const /*handle*/, avdecc_entity_model_stream_identification_cp const /*talkerStream*/, avdecc_entity_model_stream_identification_cp const /*listenerStream*/, unsigned short const /*connectionCount*/, avdecc_entity_connection_flags_t const /*flags*/, avdecc_local_entity_control_status_t const /*status*/);
	/** Called when a listener connect request has been sniffed on the network (either due to a another controller connect, or a fast connect). */
	void(^ onListenerConnectResponseSniffed)(LA_AVDECC_LOCAL_ENTITY_HANDLE const /*handle*/, avdecc_entity_model_stream_identification_cp const /*talkerStream*/, avdecc_entity_model_stream_identification_cp const /*listenerStream*/, unsigned short const /*connectionCount*/, avdecc_entity_connection_flags_t const /*flags*/, avdecc_local_entity_control_status_t const /*status*/);
	/** Called when a listener disconnect request has been sniffed on the network (either due to a another controller disconnect, or a fast disconnect). */
	void(^ onListenerDisconnectResponseSniffed)(LA_AVDECC_LOCAL_ENTITY_HANDLE const /*handle*/, avdecc_entity_model_stream_identification_cp const /*talkerStream*/, avdecc_entity_model_stream_identification_cp const /*listenerStream*/, unsigned short const /*connectionCount*/, avdecc_entity_connection_flags_t const /*flags*/, avdecc_local_entity_control_status_t const /*status*/);
	/** Called when a stream state query has been sniffed on the network. */
	void(^ onGetTalkerStreamStateResponseSniffed)(LA_AVDECC_LOCAL_ENTITY_HANDLE const /*handle*/, avdecc_entity_model_stream_identification_cp const /*talkerStream*/, avdecc_entity_model_stream_identification_cp const /*listenerStream*/, unsigned short const /*connectionCount*/, avdecc_entity_connection_flags_t const /*flags*/, avdecc_local_entity_control_status_t const /*status*/);
	/** Called when a stream state query has been sniffed on the network */
	void(^ onGetListenerStreamStateResponseSniffed)(LA_AVDECC_LOCAL_ENTITY_HANDLE const /*handle*/, avdecc_entity_model_stream_identification_cp const /*talkerStream*/, avdecc_entity_model_stream_identification_cp const /*listenerStream*/, unsigned short const /*connectionCount*/, avdecc_entity_connection_flags_t const /*flags*/, avdecc_local_entity_control_status_t const /*status*/);

	/* Unsolicited notifications (not triggered for our own commands, the command's 'result' method will be called in that case). Only successfull commands can cause an unsolicited notification. */
	/** Called when an entity has been deregistered from unsolicited notifications. */
	void(^ onDeregisteredFromUnsolicitedNotifications)(LA_AVDECC_LOCAL_ENTITY_HANDLE const /*handle*/, avdecc_unique_identifier_t const /*entityID*/);
	/** Called when an entity has been acquired by another controller. */
	void(^ onEntityAcquired)(LA_AVDECC_LOCAL_ENTITY_HANDLE const /*handle*/, avdecc_unique_identifier_t const /*entityID*/, avdecc_unique_identifier_t const /*owningEntity*/, avdecc_entity_model_descriptor_type_t const /*descriptorType*/, avdecc_entity_model_descriptor_index_t const /*descriptorIndex*/);
	/** Called when an entity has been released by another controller. */
	void(^ onEntityReleased)(LA_AVDECC_LOCAL_ENTITY_HANDLE const /*handle*/, avdecc_unique_identifier_t const /*entityID*/, avdecc_unique_identifier_t const /*owningEntity*/, avdecc_entity_model_descriptor_type_t const /*descriptorType*/, avdecc_entity_model_descriptor_index_t const /*descriptorIndex*/);
	/** Called when an entity has been locked by another controller. */
	void(^ onEntityLocked)(LA_AVDECC_LOCAL_ENTITY_HANDLE const /*handle*/, avdecc_unique_identifier_t const /*entityID*/, avdecc_unique_identifier_t const /*lockingEntity*/, avdecc_entity_model_descriptor_type_t const /*descriptorType*/, avdecc_entity_model_descriptor_index_t const /*descriptorIndex*/);
	/** Called when an entity has been unlocked by another controller (or because of the lock timeout). */
	void(^ onEntityUnlocked)(LA_AVDECC_LOCAL_ENTITY_HANDLE const /*handle*/, avdecc_unique_identifier_t const /*entityID*/, avdecc_unique_identifier_t const /*lockingEntity*/, avdecc_entity_model_descriptor_type_t const /*descriptorType*/, avdecc_entity_model_descriptor_index_t const /*descriptorIndex*/);
	/** Called when the current configuration was changed by another controller. */
	void(^ onConfigurationChanged)(LA_AVDECC_LOCAL_ENTITY_HANDLE const /*handle*/, avdecc_unique_identifier_t const /*entityID*/, avdecc_entity_model_descriptor_index_t const /*configurationIndex*/);
	/** Called when the format of an input stream was changed by another controller. */
	void(^ onStreamInputFormatChanged)(LA_AVDECC_LOCAL_ENTITY_HANDLE const /*handle*/, avdecc_unique_identifier_t const /*entityID*/, avdecc_entity_model_descriptor_index_t const /*streamIndex*/, avdecc_entity_model_stream_format_t const /*streamFormat*/);
	/** Called when the format of an output stream was changed by another controller. */
	void(^ onStreamOutputFormatChanged)(LA_AVDECC_LOCAL_ENTITY_HANDLE const /*handle*/, avdecc_unique_identifier_t const /*entityID*/, avdecc_entity_model_descriptor_index_t const /*streamIndex*/, avdecc_entity_model_stream_format_t const /*streamFormat*/);
	/** Called when the audio mappings of a stream port input was changed by another controller. */
	void(^ onStreamPortInputAudioMappingsChanged)(LA_AVDECC_LOCAL_ENTITY_HANDLE const /*handle*/, avdecc_unique_identifier_t const /*entityID*/, avdecc_entity_model_descriptor_index_t const /*streamPortIndex*/, avdecc_entity_model_descriptor_index_t const /*numberOfMaps*/, avdecc_entity_model_descriptor_index_t const /*mapIndex*/, avdecc_entity_model_audio_mapping_cp const* const /*mappings*/);
	/** Called when the audio mappings of a stream port output was changed by another controller. */
	void(^ onStreamPortOutputAudioMappingsChanged)(LA_AVDECC_LOCAL_ENTITY_HANDLE const /*handle*/, avdecc_unique_identifier_t const /*entityID*/, avdecc_entity_model_descriptor_index_t const /*streamPortIndex*/, avdecc_entity_model_descriptor_index_t const /*numberOfMaps*/, avdecc_entity_model_descriptor_index_t const /*mapIndex*/, avdecc_entity_model_audio_mapping_cp const* const /*mappings*/);
	/** Called when the information of an input stream was changed by another controller. */
	void(^ onStreamInputInfoChanged)(LA_AVDECC_LOCAL_ENTITY_HANDLE const /*handle*/, avdecc_unique_identifier_t const /*entityID*/, avdecc_entity_model_descriptor_index_t const /*streamIndex*/, avdecc_entity_model_stream_info_cp const /*info*/, avdecc_bool_t const /*fromGetStreamInfoResponse*/);
	/** Called when the information of an output stream was changed by another controller. */
	void(^ onStreamOutputInfoChanged)(LA_AVDECC_LOCAL_ENTITY_HANDLE const /*handle*/, avdecc_unique_identifier_t const /*entityID*/, avdecc_entity_model_descriptor_index_t const /*streamIndex*/, avdecc_entity_model_stream_info_cp const /*info*/, avdecc_bool_t const /*fromGetStreamInfoResponse*/);
	/** Called when the entity's name was changed by another controller. */
	void(^ onEntityNameChanged)(LA_AVDECC_LOCAL_ENTITY_HANDLE const /*handle*/, avdecc_unique_identifier_t const /*entityID*/, avdecc_fixed_string_t const /*entityName*/);
	/** Called when the entity's group name was changed by another controller. */
	void(^ onEntityGroupNameChanged)(LA_AVDECC_LOCAL_ENTITY_HANDLE const /*handle*/, avdecc_unique_identifier_t const /*entityID*/, avdecc_fixed_string_t const /*entityGroupName*/);
	/** Called when a configuration name was changed by another controller. */
	void(^ onConfigurationNameChanged)(LA_AVDECC_LOCAL_ENTITY_HANDLE const /*handle*/, avdecc_unique_identifier_t const /*entityID*/, avdecc_entity_model_descriptor_index_t const /*configurationIndex*/, avdecc_fixed_string_t const /*configurationName*/);
	/** Called when an audio unit name was changed by another controller. */
	void(^ onAudioUnitNameChanged)(LA_AVDECC_LOCAL_ENTITY_HANDLE const /*handle*/, avdecc_unique_identifier_t const /*entityID*/, avdecc_entity_model_descriptor_index_t const /*configurationIndex*/, avdecc_entity_model_descriptor_index_t const /*audioUnitIndex*/, avdecc_fixed_string_t const /*audioUnitName*/);
	/** Called when an input stream name was changed by another controller. */
	void(^ onStreamInputNameChanged)(LA_AVDECC_LOCAL_ENTITY_HANDLE const /*handle*/, avdecc_unique_identifier_t const /*entityID*/, avdecc_entity_model_descriptor_index_t const /*configurationIndex*/, avdecc_entity_model_descriptor_index_t const /*streamIndex*/, avdecc_fixed_string_t const /*streamName*/);
	/** Called when an output stream name was changed by another controller. */
	void(^ onStreamOutputNameChanged)(LA_AVDECC_LOCAL_ENTITY_HANDLE const /*handle*/, avdecc_unique_identifier_t const /*entityID*/, avdecc_entity_model_descriptor_index_t const /*configurationIndex*/, avdecc_entity_model_descriptor_index_t const /*streamIndex*/, avdecc_fixed_string_t const /*streamName*/);
	/** Called when an avb interface name was changed by another controller. */
	void(^ onAvbInterfaceNameChanged)(LA_AVDECC_LOCAL_ENTITY_HANDLE const /*handle*/, avdecc_unique_identifier_t const /*entityID*/, avdecc_entity_model_descriptor_index_t const /*configurationIndex*/, avdecc_entity_model_descriptor_index_t const /*avbInterfaceIndex*/, avdecc_fixed_string_t const /*avbInterfaceName*/);
	/** Called when a clock source name was changed by another controller. */
	void(^ onClockSourceNameChanged)(LA_AVDECC_LOCAL_ENTITY_HANDLE const /*handle*/, avdecc_unique_identifier_t const /*entityID*/, avdecc_entity_model_descriptor_index_t const /*configurationIndex*/, avdecc_entity_model_descriptor_index_t const /*clockSourceIndex*/, avdecc_fixed_string_t const /*clockSourceName*/);
	/** Called when a memory object name was changed by another controller. */
	void(^ onMemoryObjectNameChanged)(LA_AVDECC_LOCAL_ENTITY_HANDLE const /*handle*/, avdecc_unique_identifier_t const /*entityID*/, avdecc_entity_model_descriptor_index_t const /*configurationIndex*/, avdecc_entity_model_descriptor_index_t const /*memoryObjectIndex*/, avdecc_fixed_string_t const /*memoryObjectName*/);
	/** Called when an audio cluster name was changed by another controller. */
	void(^ onAudioClusterNameChanged)(LA_AVDECC_LOCAL_ENTITY_HANDLE const /*handle*/, avdecc_unique_identifier_t const /*entityID*/, avdecc_entity_model_descriptor_index_t const /*configurationIndex*/, avdecc_entity_model_descriptor_index_t const /*audioClusterIndex*/, avdecc_fixed_string_t const /*audioClusterName*/);
	/** Called when a clock domain name was changed by another controller. */
	void(^ onClockDomainNameChanged)(LA_AVDECC_LOCAL_ENTITY_HANDLE const /*handle*/, avdecc_unique_identifier_t const /*entityID*/, avdecc_entity_model_descriptor_index_t const /*configurationIndex*/, avdecc_entity_model_descriptor_index_t const /*clockDomainIndex*/, avdecc_fixed_string_t const /*clockDomainName*/);
	/** Called when an AudioUnit sampling rate was changed by another controller. */
	void(^ onAudioUnitSamplingRateChanged)(LA_AVDECC_LOCAL_ENTITY_HANDLE const /*handle*/, avdecc_unique_identifier_t const /*entityID*/, avdecc_entity_model_descriptor_index_t const /*audioUnitIndex*/, avdecc_entity_model_sampling_rate_t const /*samplingRate*/);
	/** Called when a VideoCluster sampling rate was changed by another controller. */
	void(^ onVideoClusterSamplingRateChanged)(LA_AVDECC_LOCAL_ENTITY_HANDLE const /*handle*/, avdecc_unique_identifier_t const /*entityID*/, avdecc_entity_model_descriptor_index_t const /*videoClusterIndex*/, avdecc_entity_model_sampling_rate_t const /*samplingRate*/);
	/** Called when a SensorCluster sampling rate was changed by another controller. */
	void(^ onSensorClusterSamplingRateChanged)(LA_AVDECC_LOCAL_ENTITY_HANDLE const /*handle*/, avdecc_unique_identifier_t const /*entityID*/, avdecc_entity_model_descriptor_index_t const /*sensorClusterIndex*/, avdecc_entity_model_sampling_rate_t const /*samplingRate*/);
	/** Called when a clock source was changed by another controller. */
	void(^ onClockSourceChanged)(LA_AVDECC_LOCAL_ENTITY_HANDLE const /*handle*/, avdecc_unique_identifier_t const /*entityID*/, avdecc_entity_model_descriptor_index_t const /*clockDomainIndex*/, avdecc_entity_model_descriptor_index_t const /*clockSourceIndex*/);
	/** Called when an input stream was started by another controller. */
	void(^ onStreamInputStarted)(LA_AVDECC_LOCAL_ENTITY_HANDLE const /*handle*/, avdecc_unique_identifier_t const /*entityID*/, avdecc_entity_model_descriptor_index_t const /*streamIndex*/);
	/** Called when an output stream was started by another controller. */
	void(^ onStreamOutputStarted)(LA_AVDECC_LOCAL_ENTITY_HANDLE const /*handle*/, avdecc_unique_identifier_t const /*entityID*/, avdecc_entity_model_descriptor_index_t const /*streamIndex*/);
	/** Called when an input stream was stopped by another controller. */
	void(^ onStreamInputStopped)(LA_AVDECC_LOCAL_ENTITY_HANDLE const /*handle*/, avdecc_unique_identifier_t const /*entityID*/, avdecc_entity_model_descriptor_index_t const /*streamIndex*/);
	/** Called when an output stream was stopped by another controller. */
	void(^ onStreamOutputStopped)(LA_AVDECC_LOCAL_ENTITY_HANDLE const /*handle*/, avdecc_unique_identifier_t const /*entityID*/, avdecc_entity_model_descriptor_index_t const /*streamIndex*/);
	/** Called when the Avb Info of an Avb Interface changed. */
	void(^ onAvbInfoChanged)(LA_AVDECC_LOCAL_ENTITY_HANDLE const /*handle*/, avdecc_unique_identifier_t const /*entityID*/, avdecc_entity_model_descriptor_index_t const /*avbInterfaceIndex*/, avdecc_entity_model_avb_info_cp const /*info*/);
	/** Called when the AS Path of an Avb Interface changed. */
	void(^ onAsPathChanged)(LA_AVDECC_LOCAL_ENTITY_HANDLE const /*handle*/, avdecc_unique_identifier_t const /*entityID*/, avdecc_entity_model_descriptor_index_t const /*avbInterfaceIndex*/, avdecc_entity_model_as_path_cp const /*asPath*/);
	/** Called when the counters of Entity changed. */
	void(^ onEntityCountersChanged)(LA_AVDECC_LOCAL_ENTITY_HANDLE const /*handle*/, avdecc_unique_identifier_t const /*entityID*/, avdecc_entity_entity_counter_valid_flags_t const /*validCounters*/, avdecc_entity_model_descriptor_counters_t const /*counters*/);
	/** Called when the counters of an Avb Interface changed. */
	void(^ onAvbInterfaceCountersChanged)(LA_AVDECC_LOCAL_ENTITY_HANDLE const /*handle*/, avdecc_unique_identifier_t const /*entityID*/, avdecc_entity_model_descriptor_index_t const /*avbInterfaceIndex*/, avdecc_entity_avb_interface_counter_valid_flags_t const /*validCounters*/, avdecc_entity_model_descriptor_counters_t const /*counters*/);
	/** Called when the counters of a Clock Domain changed. */
	void(^ onClockDomainCountersChanged)(LA_AVDECC_LOCAL_ENTITY_HANDLE const /*handle*/, avdecc_unique_identifier_t const /*entityID*/, avdecc_entity_model_descriptor_index_t const /*clockDomainIndex*/, avdecc_entity_clock_domain_counter_valid_flags_t const /*validCounters*/, avdecc_entity_model_descriptor_counters_t const /*counters*/);
	/** Called when the counters of a Stream Input changed. */
	void(^ onStreamInputCountersChanged)(LA_AVDECC_LOCAL_ENTITY_HANDLE const /*handle*/, avdecc_unique_identifier_t const /*entityID*/, avdecc_entity_model_descriptor_index_t const /*streamIndex*/, avdecc_entity_stream_input_counter_valid_flags_t const /*validCounters*/, avdecc_entity_model_descriptor_counters_t const /*counters*/);
	/** Called when the counters of a Stream Output changed. */
	void(^ onStreamOutputCountersChanged)(LA_AVDECC_LOCAL_ENTITY_HANDLE const /*handle*/, avdecc_unique_identifier_t const /*entityID*/, avdecc_entity_model_descriptor_index_t const /*streamIndex*/, avdecc_entity_stream_output_counter_valid_flags_t const /*validCounters*/, avdecc_entity_model_descriptor_counters_t const /*counters*/);
	/** Called when (some or all) audio mappings of a stream port input were added by another controller. */
	void(^ onStreamPortInputAudioMappingsAdded)(LA_AVDECC_LOCAL_ENTITY_HANDLE const /*handle*/, avdecc_unique_identifier_t const /*entityID*/, avdecc_entity_model_descriptor_index_t const /*streamPortIndex*/, avdecc_entity_model_audio_mapping_cp const* const /*mappings*/);
	/** Called when (some or all) audio mappings of a stream port output were added by another controller. */
	void(^ onStreamPortOutputAudioMappingsAdded)(LA_AVDECC_LOCAL_ENTITY_HANDLE const /*handle*/, avdecc_unique_identifier_t const /*entityID*/, avdecc_entity_model_descriptor_index_t const /*streamPortIndex*/, avdecc_entity_model_audio_mapping_cp const* const /*mappings*/);
	/** Called when (some or all) audio mappings of a stream port input were removed by another controller. */
	void(^ onStreamPortInputAudioMappingsRemoved)(LA_AVDECC_LOCAL_ENTITY_HANDLE const /*handle*/, avdecc_unique_identifier_t const /*entityID*/, avdecc_entity_model_descriptor_index_t const /*streamPortIndex*/, avdecc_entity_model_audio_mapping_cp const* const /*mappings*/);
	/** Called when (some or all) audio mappings of a stream port output were removed by another controller. */
	void(^ onStreamPortOutputAudioMappingsRemoved)(LA_AVDECC_LOCAL_ENTITY_HANDLE const /*handle*/, avdecc_unique_identifier_t const /*entityID*/, avdecc_entity_model_descriptor_index_t const /*streamPortIndex*/, avdecc_entity_model_audio_mapping_cp const* const /*mappings*/);
	/** Called when the length of a MemoryObject changed. */
	void(^ onMemoryObjectLengthChanged)(LA_AVDECC_LOCAL_ENTITY_HANDLE const /*handle*/, avdecc_unique_identifier_t const /*entityID*/, avdecc_entity_model_descriptor_index_t const /*configurationIndex*/, avdecc_entity_model_descriptor_index_t const /*memoryObjectIndex*/, unsigned long long const /*length*/);
	/** Called when there is a status update on an ongoing Operation */
	void(^ onOperationStatus)(LA_AVDECC_LOCAL_ENTITY_HANDLE const /*handle*/, avdecc_unique_identifier_t const /*entityID*/, avdecc_entity_model_descriptor_type_t const /*descriptorType*/, avdecc_entity_model_descriptor_index_t const /*descriptorIndex*/, avdecc_entity_model_operation_id_t const /*operationID*/, unsigned short const /*percentComplete*/);

	/* Identification notifications */
	/** Called when an entity emits an identify notification. */
	void(^ onEntityIdentifyNotification)(LA_AVDECC_LOCAL_ENTITY_HANDLE const /*handle*/, avdecc_unique_identifier_t const /*entityID*/);

	/* **** Statistics **** */
	/** Notification for when an AECP Command was resent due to a timeout. If the retry time out again, then onAecpTimeout will be called. */
	void(^ onAecpRetry)(LA_AVDECC_LOCAL_ENTITY_HANDLE const /*handle*/, avdecc_unique_identifier_t const /*entityID*/);
	/** Notification for when an AECP Command timed out (not called when onAecpRetry is called). */
	void(^ onAecpTimeout)(LA_AVDECC_LOCAL_ENTITY_HANDLE const /*handle*/, avdecc_unique_identifier_t const /*entityID*/);
	/** Notification for when an AECP Response is received but is not expected (might have already timed out). */
	void(^ onAecpUnexpectedResponse)(LA_AVDECC_LOCAL_ENTITY_HANDLE const /*handle*/, avdecc_unique_identifier_t const /*entityID*/);
	/** Notification for when an AECP Response is received (not an Unsolicited one) along with the time elapsed between the send and the receive. */
	void(^ onAecpResponseTime)(LA_AVDECC_LOCAL_ENTITY_HANDLE const /*handle*/, avdecc_unique_identifier_t const /*entityID*/, unsigned long long /*responseTimeMsec*/);
	/** Notification for when an AEM-AECP Unsolicited Response was received. */
	void(^ onAemAecpUnsolicitedReceived)(LA_AVDECC_LOCAL_ENTITY_HANDLE const /*handle*/, avdecc_unique_identifier_t const /*entityID*/, avdecc_protocol_aecp_sequence_id_t const /*sequenceID*/);
} avdecc_local_entity_controller_block_delegate_t, *avdecc_local_entity_controller_block_delegate_p;
#endif /* __BLOCKS__ */
...
#if __BLOCKS__
/* Enumeration and Control Protocol (AECP) AEM handlers */
typedef void(LA_AVDECC_BINDINGS_C_CALL_CONVENTION^ avdecc_local_entity_acquire_entity_block)(LA_AVDECC_LOCAL_ENTITY_HANDLE const /*handle*/, avdecc_unique_identifier_t const /*entityID*/, avdecc_local_entity_aem_command_status_t const /*status*/, avdecc_unique_identifier_t const /*owningEntity*/, avdecc_entity_model_descriptor_type_t const /*descriptorType*/, avdecc_entity_model_descriptor_index_t const /*descriptorIndex*/);
typedef void(LA_AVDECC_BINDINGS_C_CALL_CONVENTION^ avdecc_local_entity_release_entity_block)(LA_AVDECC_LOCAL_ENTITY_HANDLE const /*handle*/, avdecc_unique_identifier_t const /*entityID*/, avdecc_local_entity_aem_command_status_t const /*status*/, avdecc_unique_identifier_t const /*owningEntity*/, avdecc_entity_model_descriptor_type_t const /*descriptorType*/, avdecc_entity_model_descriptor_index_t const /*descriptorIndex*/);
typedef void(LA_AVDECC_BINDINGS_C_CALL_CONVENTION^ avdecc_local_entity_lock_entity_block)(LA_AVDECC_LOCAL_ENTITY_HANDLE const /*handle*/, avdecc_unique_identifier_t const /*entityID*/, avdecc_local_entity_aem_command_status_t const /*status*/, avdecc_unique_identifier_t const /*lockingEntity*/, avdecc_entity_model_descriptor_type_t const /*descriptorType*/, avdecc_entity_model_descriptor_index_t const /*descriptorIndex*/);
typedef void(LA_AVDECC_BINDINGS_C_CALL_CONVENTION^ avdecc_local_entity_unlock_entity_block)(LA_AVDECC_LOCAL_ENTITY_HANDLE const /*handle*/, avdecc_unique_identifier_t const /*entityID*/, avdecc_local_entity_aem_command_status_t const /*status*/, avdecc_unique_identifier_t const /*lockingEntity*/, avdecc_entity_model_descriptor_type_t const /*descriptorType*/, avdecc_entity_model_descriptor_index_t const /*descriptorIndex*/);
typedef void(LA_AVDECC_BINDINGS_C_CALL_CONVENTION^ avdecc_local_entity_query_entity_available_block)(LA_AVDECC_LOCAL_ENTITY_HANDLE const /*handle*/, avdecc_unique_identifier_t const /*entityID*/, avdecc_local_entity_aem_command_status_t const /*status*/);
typedef void(LA_AVDECC_BINDINGS_C_CALL_CONVENTION^ avdecc_local_entity_query_controller_available_block)(LA_AVDECC_LOCAL_ENTITY_HANDLE const /*handle*/, avdecc_unique_identifier_t const /*entityID*/, avdecc_local_entity_aem_command_status_t const /*status*/);
typedef void(LA_AVDECC_BINDINGS_C_CALL_CONVENTION^ avdecc_local_entity_register_unsolicited_notifications_block)(LA_AVDECC_LOCAL_ENTITY_HANDLE const /*handle*/, avdecc_unique_identifier_t const /*entityID*/, avdecc_local_entity_aem_command_status_t const /*status*/);
typedef void(LA_AVDECC_BINDINGS_C_CALL_CONVENTION^ avdecc_local_entity_unregister_unsolicited_notifications_block)(LA_AVDECC_LOCAL_ENTITY_HANDLE const /*handle*/, avdecc_unique_identifier_t const /*entityID*/, avdecc_local_entity_aem_command_status_t const /*status*/);
typedef void(LA_AVDECC_BINDINGS_C_CALL_CONVENTION^ avdecc_local_entity_read_entity_descriptor_block)(LA_AVDECC_LOCAL_ENTITY_HANDLE const /*handle*/, avdecc_unique_identifier_t const /*entityID*/, avdecc_local_entity_aem_command_status_t const /*status*/, avdecc_entity_model_entity_descriptor_cp const /*descriptor*/);
typedef void(LA_AVDECC_BINDINGS_C_CALL_CONVENTION^ avdecc_local_entity_read_configuration_descriptor_block)(LA_AVDECC_LOCAL_ENTITY_HANDLE const /*handle*/, avdecc_unique_identifier_t const /*entityID*/, avdecc_local_entity_aem_command_status_t const /*status*/, avdecc_entity_model_descriptor_index_t const /*configurationIndex*/, avdecc_entity_model_configuration_descriptor_cp const /*descriptor*/);
typedef void(LA_AVDECC_BINDINGS_C_CALL_CONVENTION^ avdecc_local_entity_read_audio_unit_descriptor_block)(LA_AVDECC_LOCAL_ENTITY_HANDLE const /*handle*/, avdecc_unique_identifier_t const /*entityID*/, avdecc_local_entity_aem_command_status_t const /*status*/, avdecc_entity_model_descriptor_index_t const /*configurationIndex*/, avdecc_entity_model_descriptor_index_t const /*audioUnitIndex*/, avdecc_entity_model_audio_unit_descriptor_cp const /*descriptor*/);
typedef void(LA_AVDECC_BINDINGS_C_CALL_CONVENTION^ avdecc_local_entity_read_stream_input_descriptor_block)(LA_AVDECC_LOCAL_ENTITY_HANDLE const /*handle*/, avdecc_unique_identifier_t const /*entityID*/, avdecc_local_entity_aem_command_status_t const /*status*/, avdecc_entity_model_descriptor_index_t const /*configurationIndex*/, avdecc_entity_model_descriptor_index_t const /*streamIndex*/, avdecc_entity_model_stream_descriptor_cp const /*descriptor*/);
typedef void(LA_AVDECC_BINDINGS_C_CALL_CONVENTION^ avdecc_local_entity_read_stream_output_descriptor_block)(LA_AVDECC_LOCAL_ENTITY_HANDLE const /*handle*/, avdecc_unique_identifier_t const /*entityID*/, avdecc_local_entity_aem_command_status_t const /*status*/, avdecc_entity_model_descriptor_index_t const /*configurationIndex*/, avdecc_entity_model_descriptor_index_t const /*streamIndex*/, avdecc_entity_model_stream_descriptor_cp const /*descriptor*/);
typedef void(LA_AVDECC_BINDINGS_C_CALL_CONVENTION^ avdecc_local_entity_read_jack_input_descriptor_block)(LA_AVDECC_LOCAL_ENTITY_HANDLE const /*handle*/, avdecc_unique_identifier_t const /*entityID*/, avdecc_local_entity_aem_command_status_t const /*status*/, avdecc_entity_model_descriptor_index_t const /*configurationIndex*/, avdecc_entity_model_descriptor_index_t const /*jackIndex*/, avdecc_entity_model_jack_descriptor_cp const /*descriptor*/);
typedef void(LA_AVDECC_BINDINGS_C_CALL_CONVENTION^ avdecc_local_entity_read_jack_output_descriptor_block)(LA_AVDECC_LOCAL_ENTITY_HANDLE const /*handle*/, avdecc_unique_identifier_t const /*entityID*/, avdecc_local_entity_aem_command_status_t const /*status*/, avdecc_entity_model_descriptor_index_t const /*configurationIndex*/, avdecc_entity_model_descriptor_index_t const /*jackIndex*/, avdecc_entity_model_jack_descriptor_cp const /*descriptor*/);
typedef void(LA_AVDECC_BINDINGS_C_CALL_CONVENTION^ avdecc_local_entity_read_avb_interface_descriptor_block)(LA_AVDECC_LOCAL_ENTITY_HANDLE const /*handle*/, avdecc_unique_identifier_t const /*entityID*/, avdecc_local_entity_aem_command_status_t const /*status*/, avdecc_entity_model_descriptor_index_t const /*configurationIndex*/, avdecc_entity_model_descriptor_index_t const /*avbInterfaceIndex*/, avdecc_entity_model_avb_interface_descriptor_cp const /*descriptor*/);
typedef void(LA_AVDECC_BINDINGS_C_CALL_CONVENTION^ avdecc_local_entity_read_clock_source_descriptor_block)(LA_AVDECC_LOCAL_ENTITY_HANDLE const /*handle*/, avdecc_unique_identifier_t const /*entityID*/, avdecc_local_entity_aem_command_status_t const /*status*/, avdecc_entity_model_descriptor_index_t const /*configurationIndex*/, avdecc_entity_model_descriptor_index_t const /*clockSourceIndex*/, avdecc_entity_model_clock_source_descriptor_cp const /*descriptor*/);
typedef void(LA_AVDECC_BINDINGS_C_CALL_CONVENTION^ avdecc_local_entity_read_memory_object_descriptor_block)(LA_AVDECC_LOCAL_ENTITY_HANDLE const /*handle*/, avdecc_unique_identifier_t const /*entityID*/, avdecc_local_entity_aem_command_status_t const /*status*/, avdecc_entity_model_descriptor_index_t const /*configurationIndex*/, avdecc_entity_model_descriptor_index_t const /*memoryObjectIndex*/, avdecc_entity_model_memory_object_descriptor_cp const /*descriptor*/);
typedef void(LA_AVDECC_BINDINGS_C_CALL_CONVENTION^ avdecc_local_entity_read_locale_descriptor_block)(LA_AVDECC_LOCAL_ENTITY_HANDLE const /*handle*/, avdecc_unique_identifier_t const /*entityID*/, avdecc_local_entity_aem_command_status_t const /*status*/, avdecc_entity_model_descriptor_index_t const /*configurationIndex*/, avdecc_entity_model_descriptor_index_t const /*localeIndex*/, avdecc_entity_model_locale_descriptor_cp const /*descriptor*/);
typedef void(LA_AVDECC_BINDINGS_C_CALL_CONVENTION^ avdecc_local_entity_read_strings_descriptor_block)(LA_AVDECC_LOCAL_ENTITY_HANDLE const /*handle*/, avdecc_unique_identifier_t const /*entityID*/, avdecc_local_entity_aem_command_status_t const /*status*/, avdecc_entity_model_descriptor_index_t const /*configurationIndex*/, avdecc_entity_model_descriptor_index_t const /*stringsIndex*/, avdecc_entity_model_strings_descriptor_cp const /*descriptor*/);
typedef void(LA_AVDECC_BINDINGS_C_CALL_CONVENTION^ avdecc_local_entity_read_stream_port_input_descriptor_block)(LA_AVDECC_LOCAL_ENTITY_HANDLE const /*handle*/, avdecc_unique_identifier_t const /*entityID*/, avdecc_local_entity_aem_command_status_t const /*status*/, avdecc_entity_model_descriptor_index_t const /*configurationIndex*/, avdecc_entity_model_descriptor_index_t const /*streamPortIndex*/, avdecc_entity_model_stream_port_descriptor_cp const /*descriptor*/);
typedef void(LA_AVDECC_BINDINGS_C_CALL_CONVENTION^ avdecc_local_entity_read_stream_port_output_descriptor_block)(LA_AVDECC_LOCAL_ENTITY_HANDLE const /*handle*/, avdecc_unique_identifier_t const /*entityID*/, avdecc_local_entity_aem_command_status_t const /*status*/, avdecc_entity_model_descriptor_index_t const /*configurationIndex*/, avdecc_entity_model_descriptor_index_t const /*streamPortIndex*/, avdecc_entity_model_stream_port_descriptor_cp const /*descriptor*/);
typedef void(LA_AVDECC_BINDINGS_C_CALL_CONVENTION^ avdecc_local_entity_read_external_port_input_descriptor_block)(LA_AVDECC_LOCAL_ENTITY_HANDLE const /*handle*/, avdecc_unique_identifier_t const /*entityID*/, avdecc_local_entity_aem_command_status_t const /*status*/, avdecc_entity_model_descriptor_index_t const /*configurationIndex*/, avdecc_entity_model_descriptor_index_t const /*externalPortIndex*/, avdecc_entity_model_external_port_descriptor_cp const /*descriptor*/);
typedef void(LA_AVDECC_BINDINGS_C_CALL_CONVENTION^ avdecc_local_entity_read_external_port_output_descriptor_block)(LA_AVDECC_LOCAL_ENTITY_HANDLE const /*handle*/, avdecc_unique_identifier_t const /*entityID*/, avdecc_local_entity_aem_command_status_t const /*status*/, avdecc_entity_model_descriptor_index_t const /*configurationIndex*/, avdecc_entity_model_descriptor_index_t const /*externalPortIndex*/, avdecc_entity_model_external_port_descriptor_cp const /*descriptor*/);
typedef void(LA_AVDECC_BINDINGS_C_CALL_CONVENTION^ avdecc_local_entity_read_internal_port_input_descriptor_block)(LA_AVDECC_LOCAL_ENTITY_HANDLE const /*handle*/, avdecc_unique_identifier_t const /*entityID*/, avdecc_local_entity_aem_command_status_t const /*status*/, avdecc_entity_model_descriptor_index_t const /*configurationIndex*/, avdecc_entity_model_descriptor_index_t const /*internalPortIndex*/, avdecc_entity_model_internal_port_descriptor_cp const /*descriptor*/);
typedef void(LA_AVDECC_BINDINGS_C_CALL_CONVENTION^ avdecc_local_entity_read_internal_port_output_descriptor_block)(LA_AVDECC_LOCAL_ENTITY_HANDLE const /*handle*/, avdecc_unique_identifier_t const /*entityID*/, avdecc_local_entity_aem_command_status_t const /*status*/, avdecc_entity_model_descriptor_index_t const /*configurationIndex*/, avdecc_entity_model_descriptor_index_t const /*internalPortIndex*/, avdecc_entity_model_internal_port_descriptor_cp const /*descriptor*/);
typedef void(LA_AVDECC_BINDINGS_C_CALL_CONVENTION^ avdecc_local_entity_read_audio_cluster_descriptor_block)(LA_AVDECC_LOCAL_ENTITY_HANDLE const /*handle*/, avdecc_unique_identifier_t const /*entityID*/, avdecc_local_entity_aem_command_status_t const /*status*/, avdecc_entity_model_descriptor_index_t const /*configurationIndex*/, avdecc_entity_model_descriptor_index_t const /*clusterIndex*/, avdecc_entity_model_audio_cluster_descriptor_cp const /*descriptor*/);
typedef void(LA_AVDECC_BINDINGS_C_CALL_CONVENTION^ avdecc_local_entity_read_audio_map_descriptor_block)(LA_AVDECC_LOCAL_ENTITY_HANDLE const /*handle*/, avdecc_unique_identifier_t const /*entityID*/, avdecc_local_entity_aem_command_status_t const /*status*/, avdecc_entity_model_descriptor_index_t const /*configurationIndex*/, avdecc_entity_model_descriptor_index_t const /*mapIndex*/, avdecc_entity_model_audio_map_descriptor_cp const /*descriptor*/);
typedef void(LA_AVDECC_BINDINGS_C_CALL_CONVENTION^ avdecc_local_entity_read_clock_domain_descriptor_block)(LA_AVDECC_LOCAL_ENTITY_HANDLE const /*handle*/, avdecc_unique_identifier_t const /*entityID*/, avdecc_local_entity_aem_command_status_t const /*status*/, avdecc_entity_model_descriptor_index_t const /*configurationIndex*/, avdecc_entity_model_descriptor_index_t const /*clockDomainIndex*/, avdecc_entity_model_clock_domain_descriptor_cp const /*descriptor*/);
typedef void(LA_AVDECC_BINDINGS_C_CALL_CONVENTION^ avdecc_local_entity_set_configuration_block)(LA_AVDECC_LOCAL_ENTITY_HANDLE const /*handle*/, avdecc_unique_identifier_t const /*entityID*/, avdecc_local_entity_aem_command_status_t const /*status*/, avdecc_entity_model_descriptor_index_t const /*configurationIndex*/);
typedef void(LA_AVDECC_BINDINGS_C_CALL_CONVENTION^ avdecc_local_entity_get_configuration_block)(LA_AVDECC_LOCAL_ENTITY_HANDLE const /*handle*/, avdecc_unique_identifier_t const /*entityID*/, avdecc_local_entity_aem_command_status_t const /*status*/, avdecc_entity_model_descriptor_index_t const /*configurationIndex*/);
typedef void(LA_AVDECC_BINDINGS_C_CALL_CONVENTION^ avdecc_local_entity_set_stream_input_format_block)(LA_AVDECC_LOCAL_ENTITY_HANDLE const /*handle*/, avdecc_unique_identifier_t const /*entityID*/, avdecc_local_entity_aem_command_status_t const /*status*/, avdecc_entity_model_descriptor_index_t const /*streamIndex*/, avdecc_entity_model_stream_format_t const /*streamFormat*/);
typedef void(LA_AVDECC_BINDINGS_C_CALL_CONVENTION^ avdecc_local_entity_get_stream_input_format_block)(LA_AVDECC_LOCAL_ENTITY_HANDLE const /*handle*/, avdecc_unique_identifier_t const /*entityID*/, avdecc_local_entity_aem_command_status_t const /*status*/, avdecc_entity_model_descriptor_index_t const /*streamIndex*/, avdecc_entity_model_stream_format_t const /*streamFormat*/);
typedef void(LA_AVDECC_BINDINGS_C_CALL_CONVENTION^ avdecc_local_entity_set_stream_output_format_block)(LA_AVDECC_LOCAL_ENTITY_HANDLE const /*handle*/, avdecc_unique_identifier_t const /*entityID*/, avdecc_local_entity_aem_command_status_t const /*status*/, avdecc_entity_model_descriptor_index_t const /*streamIndex*/, avdecc_entity_model_stream_format_t const /*streamFormat*/);
typedef void(LA_AVDECC_BINDINGS_C_CALL_CONVENTION^ avdecc_local_entity_get_stream_output_format_block)(LA_AVDECC_LOCAL_ENTITY_HANDLE const /*handle*/, avdecc_unique_identifier_t const /*entityID*/, avdecc_local_entity_aem_command_status_t const /*status*/, avdecc_entity_model_descriptor_index_t const /*streamIndex*/, avdecc_entity_model_stream_format_t const /*streamFormat*/);
typedef void(LA_AVDECC_BINDINGS_C_CALL_CONVENTION^ avdecc_local_entity_get_stream_port_input_audio_map_block)(LA_AVDECC_LOCAL_ENTITY_HANDLE const /*handle*/, avdecc_unique_identifier_t const /*entityID*/, avdecc_local_entity_aem_command_status_t const /*status*/, avdecc_entity_model_descriptor_index_t const /*streamPortIndex*/, avdecc_entity_model_descriptor_index_t const /*numberOfMaps*/, avdecc_entity_model_descriptor_index_t const /*mapIndex*/, avdecc_entity_model_audio_mapping_cp const* const /*mappings*/);
typedef void(LA_AVDECC_BINDINGS_C_CALL_CONVENTION^ avdecc_local_entity_get_stream_port_output_audio_map_block)(LA_AVDECC_LOCAL_ENTITY_HANDLE const /*handle*/, avdecc_unique_identifier_t const /*entityID*/, avdecc_local_entity_aem_command_status_t const /*status*/, avdecc_entity_model_descriptor_index_t const /*streamPortIndex*/, avdecc_entity_model_descriptor_index_t const /*numberOfMaps*/, avdecc_entity_model_descriptor_index_t const /*mapIndex*/, avdecc_entity_model_audio_mapping_cp const* const /*mappings*/);
typedef void(LA_AVDECC_BINDINGS_C_CALL_CONVENTION^ avdecc_local_entity_add_stream_port_input_audio_mappings_block)(LA_AVDECC_LOCAL_ENTITY_HANDLE const /*handle*/, avdecc_unique_identifier_t const /*entityID*/, avdecc_local_entity_aem_command_status_t const /*status*/, avdecc_entity_model_descriptor_index_t const /*streamPortIndex*/, avdecc_entity_model_audio_mapping_cp const* const /*mappings*/);
typedef void(LA_AVDECC_BINDINGS_C_CALL_CONVENTION^ avdecc_local_entity_add_stream_port_output_audio_mappings_block)(LA_AVDECC_LOCAL_ENTITY_HANDLE const /*handle*/, avdecc_unique_identifier_t const /*entityID*/, avdecc_local_entity_aem_command_status_t const /*status*/, avdecc_entity_model_descriptor_index_t const /*streamPortIndex*/, avdecc_entity_model_audio_mapping_cp const* const /*mappings*/);
typedef void(LA_AVDECC_BINDINGS_C_CALL_CONVENTION^ avdecc_local_entity_remove_stream_port_input_audio_mappings_block)(LA_AVDECC_LOCAL_ENTITY_HANDLE const /*handle*/, avdecc_unique_identifier_t const /*entityID*/, avdecc_local_entity_aem_command_status_t const /*status*/, avdecc_entity_model_descriptor_index_t const /*streamPortIndex*/, avdecc_entity_model_audio_mapping_cp const* const /*mappings*/);
typedef void(LA_AVDECC_BINDINGS_C_CALL_CONVENTION^ avdecc_local_entity_remove_stream_port_output_audio_mappings_block)(LA_AVDECC_LOCAL_ENTITY_HANDLE const /*handle*/, avdecc_unique_identifier_t const /*entityID*/, avdecc_local_entity_aem_command_status_t const /*status*/, avdecc_entity_model_descriptor_index_t const /*streamPortIndex*/, avdecc_entity_model_audio_mapping_cp const* const /*mappings*/);
typedef void(LA_AVDECC_BINDINGS_C_CALL_CONVENTION^ avdecc_local_entity_set_stream_input_info_block)(LA_AVDECC_LOCAL_ENTITY_HANDLE const /*handle*/, avdecc_unique_identifier_t const /*entityID*/, avdecc_local_entity_aem_command_status_t const /*status*/, avdecc_entity_model_descriptor_index_t const /*streamIndex*/, avdecc_entity_model_stream_info_cp const /*info*/);
typedef void(LA_AVDECC_BINDINGS_C_CALL_CONVENTION^ avdecc_local_entity_set_stream_output_info_block)(LA_AVDECC_LOCAL_ENTITY_HANDLE const /*handle*/, avdecc_unique_identifier_t const /*entityID*/, avdecc_local_entity_aem_command_status_t const /*status*/, avdecc_entity_model_descriptor_index_t const /*streamIndex*/, avdecc_entity_model_stream_info_cp const /*info*/);
typedef void(LA_AVDECC_BINDINGS_C_CALL_CONVENTION^ avdecc_local_entity_get_stream_input_info_block)(LA_AVDECC_LOCAL_ENTITY_HANDLE const /*handle*/, avdecc_unique_identifier_t const /*entityID*/, avdecc_local_entity_aem_command_status_t const /*status*/, avdecc_entity_model_descriptor_index_t const /*streamIndex*/, avdecc_entity_model_stream_info_cp const /*info*/);
typedef void(LA_AVDECC_BINDINGS_C_CALL_CONVENTION^ avdecc_local_entity_get_stream_output_info_block)(LA_AVDECC_LOCAL_ENTITY_HANDLE const /*handle*/, avdecc_unique_identifier_t const /*entityID*/, avdecc_local_entity_aem_command_status_t const /*status*/, avdecc_entity_model_descriptor_index_t const /*streamIndex*/, avdecc_entity_model_stream_info_cp const /*info*/);
typedef void(LA_AVDECC_BINDINGS_C_CALL_CONVENTION^ avdecc_local_entity_set_entity_name_block)(LA_AVDECC_LOCAL_ENTITY_HANDLE const /*handle*/, avdecc_unique_identifier_t const /*entityID*/, avdecc_local_entity_aem_command_status_t const /*status*/, avdecc_fixed_string_t const /*entityName*/);
typedef void(LA_AVDECC_BINDINGS_C_CALL_CONVENTION^ avdecc_local_entity_get_entity_name_block)(LA_AVDECC_LOCAL_ENTITY_HANDLE const /*handle*/, avdecc_unique_identifier_t const /*entityID*/, avdecc_local_entity_aem_command_status_t const /*status*/, avdecc_fixed_string_t const /*entityName*/);
typedef void(LA_AVDECC_BINDINGS_C_CALL_CONVENTION^ avdecc_local_entity_set_entity_group_name_block)(LA_AVDECC_LOCAL_ENTITY_HANDLE const /*handle*/, avdecc_unique_identifier_t const /*entityID*/, avdecc_local_entity_aem_command_status_t const /*status*/, avdecc_fixed_string_t const /*entityGroupName*/);
typedef void(LA_AVDECC_BINDINGS_C_CALL_CONVENTION^ avdecc_local_entity_get_entity_group_name_block)(LA_AVDECC_LOCAL_ENTITY_HANDLE const /*handle*/, avdecc_unique_identifier_t const /*entityID*/, avdecc_local_entity_aem_command_status_t const /*status*/, avdecc_fixed_string_t const /*entityGroupName*/);
typedef void(LA_AVDECC_BINDINGS_C_CALL_CONVENTION^ avdecc_local_entity_set_configuration_name_block)(LA_AVDECC_LOCAL_ENTITY_HANDLE const /*handle*/, avdecc_unique_identifier_t const /*entityID*/, avdecc_local_entity_aem_command_status_t const /*status*/, avdecc_entity_model_descriptor_index_t const /*configurationIndex*/, avdecc_fixed_string_t const /*configurationName*/);
typedef void(LA_AVDECC_BINDINGS_C_CALL_CONVENTION^ avdecc_local_entity_get_configuration_name_block)(LA_AVDECC_LOCAL_ENTITY_HANDLE const /*handle*/, avdecc_unique_identifier_t const /*entityID*/, avdecc_local_entity_aem_command_status_t const /*status*/, avdecc_entity_model_descriptor_index_t const /*configurationIndex*/, avdecc_fixed_string_t const /*configurationName*/);
typedef void(LA_AVDECC_BINDINGS_C_CALL_CONVENTION^ avdecc_local_entity_set_audio_unit_name_block)(LA_AVDECC_LOCAL_ENTITY_HANDLE const /*handle*/, avdecc_unique_identifier_t const /*entityID*/, avdecc_local_entity_aem_command_status_t const /*status*/, avdecc_entity_model_descriptor_index_t const /*configurationIndex*/, avdecc_entity_model_descriptor_index_t const /*audioUnitIndex*/, avdecc_fixed_string_t const /*audioUnitName*/);
typedef void(LA_AVDECC_BINDINGS_C_CALL_CONVENTION^ avdecc_local_entity_get_audio_unit_name_block)(LA_AVDECC_LOCAL_ENTITY_HANDLE const /*handle*/, avdecc_unique_identifier_t const /*entityID*/, avdecc_local_entity_aem_command_status_t const /*status*/, avdecc_entity_model_descriptor_index_t const /*configurationIndex*/, avdecc_entity_model_descriptor_index_t const /*audioUnitIndex*/, avdecc_fixed_string_t const /*audioUnitName*/);
typedef void(LA_AVDECC_BINDINGS_C_CALL_CONVENTION^ avdecc_local_entity_set_stream_input_name_block)(LA_AVDECC_LOCAL_ENTITY_HANDLE const /*handle*/, avdecc_unique_identifier_t const /*entityID*/, avdecc_local_entity_aem_command_status_t const /*status*/, avdecc_entity_model_descriptor_index_t const /*configurationIndex*/, avdecc_entity_model_descriptor_index_t const /*streamIndex*/, avdecc_fixed_string_t const /*streamInputName*/);
typedef void(LA_AVDECC_BINDINGS_C_CALL_CONVENTION^ avdecc_local_entity_get_stream_input_name_block)(LA_AVDECC_LOCAL_ENTITY_HANDLE const /*handle*/, avdecc_unique_identifier_t const /*entityID*/, avdecc_local_entity_aem_command_status_t const /*status*/, avdecc_entity_model_descriptor_index_t const /*configurationIndex*/, avdecc_entity_model_descriptor_index_t const /*streamIndex*/, avdecc_fixed_string_t const /*streamInputName*/);
typedef void(LA_AVDECC_BINDINGS_C_CALL_CONVENTION^ avdecc_local_entity_set_stream_output_name_block)(LA_AVDECC_LOCAL_ENTITY_HANDLE const /*handle*/, avdecc_unique_identifier_t const /*entityID*/, avdecc_local_entity_aem_command_status_t const /*status*/, avdecc_entity_model_descriptor_index_t const /*configurationIndex*/, avdecc_entity_model_descriptor_index_t const /*streamIndex*/, avdecc_fixed_string_t const /*streamOutputName*/);
typedef void(LA_AVDECC_BINDINGS_C_CALL_CONVENTION^ avdecc_local_entity_get_stream_output_name_block)(LA_AVDECC_LOCAL_ENTITY_HANDLE const /*handle*/, avdecc_unique_identifier_t const /*entityID*/, avdecc_local_entity_aem_command_status_t const /*status*/, avdecc_entity_model_descriptor_index_t const /*configurationIndex*/, avdecc_entity_model_descriptor_index_t const /*streamIndex*/, avdecc_fixed_string_t const /*streamOutputName*/);
typedef void(LA_AVDECC_BINDINGS_C_CALL_CONVENTION^ avdecc_local_entity_set_avb_interface_name_block)(LA_AVDECC_LOCAL_ENTITY_HANDLE const /*handle*/, avdecc_unique_identifier_t const /*entityID*/, avdecc_local_entity_aem_command_status_t const /*status*/, avdecc_entity_model_descriptor_index_t const /*configurationIndex*/, avdecc_entity_model_descriptor_index_t const /*avbInterfaceIndex*/, avdecc_fixed_string_t const /*avbInterfaceName*/);
typedef void(LA_AVDECC_BINDINGS_C_CALL_CONVENTION^ avdecc_local_entity_get_avb_interface_name_block)(LA_AVDECC_LOCAL_ENTITY_HANDLE const /*handle*/, avdecc_unique_identifier_t const /*entityID*/, avdecc_local_entity_aem_command_status_t const /*status*/, avdecc_entity_model_descriptor_index_t const /*configurationIndex*/, avdecc_entity_model_descriptor_index_t const /*avbInterfaceIndex*/, avdecc_fixed_string_t const /*avbInterfaceName*/);
typedef void(LA_AVDECC_BINDINGS_C_CALL_CONVENTION^ avdecc_local_entity_set_clock_source_name_block)(LA_AVDECC_LOCAL_ENTITY_HANDLE const /*handle*/, avdecc_unique_identifier_t const /*entityID*/, avdecc_local_entity_aem_command_status_t const /*status*/, avdecc_entity_model_descriptor_index_t const /*configurationIndex*/, avdecc_entity_model_descriptor_index_t const /*clockSourceIndex*/, avdecc_fixed_string_t const /*clockSourceName*/);
typedef void(LA_AVDECC_BINDINGS_C_CALL_CONVENTION^ avdecc_local_entity_get_clock_source_name_block)(LA_AVDECC_LOCAL_ENTITY_HANDLE const /*handle*/, avdecc_unique_identifier_t const /*entityID*/, avdecc_local_entity_aem_command_status_t const /*status*/, avdecc_entity_model_descriptor_index_t const /*configurationIndex*/, avdecc_entity_model_descriptor_index_t const /*clockSourceIndex*/, avdecc_fixed_string_t const /*clockSourceName*/);
typedef void(LA_AVDECC_BINDINGS_C_CALL_CONVENTION^ avdecc_local_entity_set_memory_object_name_block)(LA_AVDECC_LOCAL_ENTITY_HANDLE const /*handle*/, avdecc_unique_identifier_t const /*entityID*/, avdecc_local_entity_aem_command_status_t const /*status*/, avdecc_entity_model_descriptor_index_t const /*configurationIndex*/, avdecc_entity_model_descriptor_index_t const /*memoryObjectIndex*/, avdecc_fixed_string_t const /*memoryObjectName*/);
typedef void(LA_AVDECC_BINDINGS_C_CALL_CONVENTION^ avdecc_local_entity_get_memory_object_name_block)(LA_AVDECC_LOCAL_ENTITY_HANDLE const /*handle*/, avdecc_unique_identifier_t const /*entityID*/, avdecc_local_entity_aem_command_status_t const /*status*/, avdecc_entity_model_descriptor_index_t const /*configurationIndex*/, avdecc_entity_model_descriptor_index_t const /*memoryObjectIndex*/, avdecc_fixed_string_t const /*memoryObjectName*/);
typedef void(LA_AVDECC_BINDINGS_C_CALL_CONVENTION^ avdecc_local_entity_set_audio_cluster_name_block)(LA_AVDECC_LOCAL_ENTITY_HANDLE const /*handle*/, avdecc_unique_identifier_t const /*entityID*/, avdecc_local_entity_aem_command_status_t const /*status*/, avdecc_entity_model_descriptor_index_t const /*configurationIndex*/, avdecc_entity_model_descriptor_index_t const /*audioClusterIndex*/, avdecc_fixed_string_t const /*audioClusterName*/);
typedef void(LA_AVDECC_BINDINGS_C_CALL_CONVENTION^ avdecc_local_entity_get_audio_cluster_name_block)(LA_AVDECC_LOCAL_ENTITY_HANDLE const /*handle*/, avdecc_unique_identifier_t const /*entityID*/, avdecc_local_entity_aem_command_status_t const /*status*/, avdecc_entity_model_descriptor_index_t const /*configurationIndex*/, avdecc_entity_model_descriptor_index_t const /*audioClusterIndex*/, avdecc_fixed_string_t const /*audioClusterName*/);
typedef void(LA_AVDECC_BINDINGS_C_CALL_CONVENTION^ avdecc_local_entity_set_clock_domain_name_block)(LA_AVDECC_LOCAL_ENTITY_HANDLE const /*handle*/, avdecc_unique_identifier_t const /*entityID*/, avdecc_local_entity_aem_command_status_t const /*status*/, avdecc_entity_model_descriptor_index_t const /*configurationIndex*/, avdecc_entity_model_descriptor_index_t const /*clockDomainIndex*/, avdecc_fixed_string_t const /*clockDomainName*/);
typedef void(LA_AVDECC_BINDINGS_C_CALL_CONVENTION^ avdecc_local_entity_get_clock_domain_name_block)(LA_AVDECC_LOCAL_ENTITY_HANDLE const /*handle*/, avdecc_unique_identifier_t const /*entityID*/, avdecc_local_entity_aem_command_status_t const /*status*/, avdecc_entity_model_descriptor_index_t const /*configurationIndex*/, avdecc_entity_model_descriptor_index_t const /*clockDomainIndex*/, avdecc_fixed_string_t const /*clockDomainName*/);
typedef void(LA_AVDECC_BINDINGS_C_CALL_CONVENTION^ avdecc_local_entity_set_audio_unit_sampling_rate_block)(LA_AVDECC_LOCAL_ENTITY_HANDLE const /*handle*/, avdecc_unique_identifier_t const /*entityID*/, avdecc_local_entity_aem_command_status_t const /*status*/, avdecc_entity_model_descriptor_index_t const /*audioUnitIndex*/, avdecc_entity_model_sampling_rate_t const /*samplingRate*/);
typedef void(LA_AVDECC_BINDINGS_C_CALL_CONVENTION^ avdecc_local_entity_get_audio_unit_sampling_rate_block)(LA_AVDECC_LOCAL_ENTITY_HANDLE const /*handle*/, avdecc_unique_identifier_t const /*entityID*/, avdecc_local_entity_aem_command_status_t const /*status*/, avdecc_entity_model_descriptor_index_t const /*audioUnitIndex*/, avdecc_entity_model_sampling_rate_t const /*samplingRate*/);
typedef void(LA_AVDECC_BINDINGS_C_CALL_CONVENTION^ avdecc_local_entity_set_video_cluster_sampling_rate_block)(LA_AVDECC_LOCAL_ENTITY_HANDLE const /*handle*/, avdecc_unique_identifier_t const /*entityID*/, avdecc_local_entity_aem_command_status_t const /*status*/, avdecc_entity_model_descriptor_index_t const /*videoClusterIndex*/, avdecc_entity_model_sampling_rate_t const /*samplingRate*/);
typedef void(LA_AVDECC_BINDINGS_C_CALL_CONVENTION^ avdecc_local_entity_get_video_cluster_sampling_rate_block)(LA_AVDECC_LOCAL_ENTITY_HANDLE const /*handle*/, avdecc_unique_identifier_t const /*entityID*/, avdecc_local_entity_aem_command_status_t const /*status*/, avdecc_entity_model_descriptor_index_t const /*videoClusterIndex*/, avdecc_entity_model_sampling_rate_t const /*samplingRate*/);
typedef void(LA_AVDECC_BINDINGS_C_CALL_CONVENTION^ avdecc_local_entity_set_sensor_cluster_sampling_rate_block)(LA_AVDECC_LOCAL_ENTITY_HANDLE const /*handle*/, avdecc_unique_identifier_t const /*entityID*/, avdecc_local_entity_aem_command_status_t const /*status*/, avdecc_entity_model_descriptor_index_t const /*sensorClusterIndex*/, avdecc_entity_model_sampling_rate_t const /*samplingRate*/);
typedef void(LA_AVDECC_BINDINGS_C_CALL_CONVENTION^ avdecc_local_entity_get_sensor_cluster_sampling_rate_block)(LA_AVDECC_LOCAL_ENTITY_HANDLE const /*handle*/, avdecc_unique_identifier_t const /*entityID*/, avdecc_local_entity_aem_command_status_t const /*status*/, avdecc_entity_model_descriptor_index_t const /*sensorClusterIndex*/, avdecc_entity_model_sampling_rate_t const /*samplingRate*/);
typedef void(LA_AVDECC_BINDINGS_C_CALL_CONVENTION^ avdecc_local_entity_set_clock_source_block)(LA_AVDECC_LOCAL_ENTITY_HANDLE const /*handle*/, avdecc_unique_identifier_t const /*entityID*/, avdecc_local_entity_aem_command_status_t const /*status*/, avdecc_entity_model_descriptor_index_t const /*clockDomainIndex*/, avdecc_entity_model_descriptor_index_t const /*clockSourceIndex*/);
typedef void(LA_AVDECC_BINDINGS_C_CALL_CONVENTION^ avdecc_local_entity_get_clock_source_block)(LA_AVDECC_LOCAL_ENTITY_HANDLE const /*handle*/, avdecc_unique_identifier_t const /*entityID*/, avdecc_local_entity_aem_command_status_t const /*status*/, avdecc_entity_model_descriptor_index_t const /*clockDomainIndex*/, avdecc_entity_model_descriptor_index_t const /*clockSourceIndex*/);
typedef void(LA_AVDECC_BINDINGS_C_CALL_CONVENTION^ avdecc_local_entity_start_stream_input_block)(LA_AVDECC_LOCAL_ENTITY_HANDLE const /*handle*/, avdecc_unique_identifier_t const /*entityID*/, avdecc_local_entity_aem_command_status_t const /*status*/, avdecc_entity_model_descriptor_index_t const /*streamIndex*/);
typedef void(LA_AVDECC_BINDINGS_C_CALL_CONVENTION^ avdecc_local_entity_start_stream_output_block)(LA_AVDECC_LOCAL_ENTITY_HANDLE const /*handle*/, avdecc_unique_identifier_t const /*entityID*/, avdecc_local_entity_aem_command_status_t const /*status*/, avdecc_entity_model_descriptor_index_t const /*streamIndex*/);
typedef void(LA_AVDECC_BINDINGS_C_CALL_CONVENTION^ avdecc_local_entity_stop_stream_input_block)(LA_AVDECC_LOCAL_ENTITY_HANDLE const /*handle*/, avdecc_unique_identifier_t const /*entityID*/, avdecc_local_entity_aem_command_status_t const /*status*/, avdecc_entity_model_descriptor_index_t const /*streamIndex*/);
typedef void(LA_AVDECC_BINDINGS_C_CALL_CONVENTION^ avdecc_local_entity_stop_stream_output_block)(LA_AVDECC_LOCAL_ENTITY_HANDLE const /*handle*/, avdecc_unique_identifier_t const /*entityID*/, avdecc_local_entity_aem_command_status_t const /*status*/, avdecc_entity_model_descriptor_index_t const /*streamIndex*/);
typedef void(LA_AVDECC_BINDINGS_C_CALL_CONVENTION^ avdecc_local_entity_get_avb_info_block)(LA_AVDECC_LOCAL_ENTITY_HANDLE const /*handle*/, avdecc_unique_identifier_t const /*entityID*/, avdecc_local_entity_aem_command_status_t const /*status*/, avdecc_entity_model_descriptor_index_t const /*avbInterfaceIndex*/, avdecc_entity_model_avb_info_cp const /*info*/);
typedef void(LA_AVDECC_BINDINGS_C_CALL_CONVENTION^ avdecc_local_entity_get_as_path_block)(LA_AVDECC_LOCAL_ENTITY_HANDLE const /*handle*/, avdecc_unique_identifier_t const /*entityID*/, avdecc_local_entity_aem_command_status_t const /*status*/, avdecc_entity_model_descriptor_index_t const /*avbInterfaceIndex*/, avdecc_entity_model_as_path_cp const /*asPath*/);
typedef void(LA_AVDECC_BINDINGS_C_CALL_CONVENTION^ avdecc_local_entity_get_entity_counters_block)(LA_AVDECC_LOCAL_ENTITY_HANDLE const /*handle*/, avdecc_unique_identifier_t const /*entityID*/, avdecc_local_entity_aem_command_status_t const /*status*/, avdecc_entity_entity_counter_valid_flags_t const /*validCounters*/, avdecc_entity_model_descriptor_counters_t const /*counters*/);
typedef void(LA_AVDECC_BINDINGS_C_CALL_CONVENTION^ avdecc_local_entity_get_avb_interface_counters_block)(LA_AVDECC_LOCAL_ENTITY_HANDLE const /*handle*/, avdecc_unique_identifier_t const /*entityID*/, avdecc_local_entity_aem_command_status_t const /*status*/, avdecc_entity_model_descriptor_index_t const /*avbInterfaceIndex*/, avdecc_entity_avb_interface_counter_valid_flags_t const /*validCounters*/, avdecc_entity_model_descriptor_counters_t const /*counters*/);
typedef void(LA_AVDECC_BINDINGS_C_CALL_CONVENTION^ avdecc_local_entity_get_clock_domain_counters_block)(LA_AVDECC_LOCAL_ENTITY_HANDLE const /*handle*/, avdecc_unique_identifier_t const /*entityID*/, avdecc_local_entity_aem_command_status_t const /*status*/, avdecc_entity_model_descriptor_index_t const /*clockDomainIndex*/, avdecc_entity_clock_domain_counter_valid_flags_t const /*validCounters*/, avdecc_entity_model_descriptor_counters_t const /*counters*/);
typedef void(LA_AVDECC_BINDINGS_C_CALL_CONVENTION^ avdecc_local_entity_get_stream_input_counters_block)(LA_AVDECC_LOCAL_ENTITY_HANDLE const /*handle*/, avdecc_unique_identifier_t const /*entityID*/, avdecc_local_entity_aem_command_status_t const /*status*/, avdecc_entity_model_descriptor_index_t const /*streamIndex*/, avdecc_entity_stream_input_counter_valid_flags_t const /*validCounters*/, avdecc_entity_model_descriptor_counters_t const /*counters*/);
typedef void(LA_AVDECC_BINDINGS_C_CALL_CONVENTION^ avdecc_local_entity_get_stream_output_counters_block)(LA_AVDECC_LOCAL_ENTITY_HANDLE const /*handle*/, avdecc_unique_identifier_t const /*entityID*/, avdecc_local_entity_aem_command_status_t const /*status*/, avdecc_entity_model_descriptor_index_t const /*streamIndex*/, avdecc_entity_stream_output_counter_valid_flags_t const /*validCounters*/, avdecc_entity_model_descriptor_counters_t const /*counters*/);
//using StartOperationHandler)(LA_AVDECC_LOCAL_ENTITY_HANDLE const /*handle*/, avdecc_unique_identifier_t const /*entityID*/, avdecc_local_entity_aem_command_status_t const /*status*/, la::avdecc::entity::model::DescriptorType const descriptorType, la::avdecc::entity::model::DescriptorIndex const descriptorIndex, la::avdecc::entity::model::OperationID const operationID, la::avdecc::entity::model::MemoryObjectOperationType const operationType, la::avdecc::MemoryBuffer const& memoryBuffer);
//using AbortOperationHandler)(LA_AVDECC_LOCAL_ENTITY_HANDLE const /*handle*/, avdecc_unique_identifier_t const /*entityID*/, avdecc_local_entity_aem_command_status_t const /*status*/, la::avdecc::entity::model::DescriptorType const descriptorType, la::avdecc::entity::model::DescriptorIndex const descriptorIndex, la::avdecc::entity::model::OperationID const operationID);
//using SetMemoryObjectLengthHandler)(LA_AVDECC_LOCAL_ENTITY_HANDLE const /*handle*/, avdecc_unique_identifier_t const /*entityID*/, avdecc_local_entity_aem_command_status_t const /*status*/, avdecc_entity_model_descriptor_index_t const /*configurationIndex*/, avdecc_entity_model_descriptor_index_t const /*memoryObjectIndex*/, unsigned long long const length);
//using GetMemoryObjectLengthHandler)(LA_AVDECC_LOCAL_ENTITY_HANDLE const /*handle*/, avdecc_unique_identifier_t const /*entityID*/, avdecc_local_entity_aem_command_status_t const /*status*/, avdecc_entity_model_descriptor_index_t const /*configurationIndex*/, avdecc_entity_model_descriptor_index_t const /*memoryObjectIndex*/, unsigned long long const length);
///* Enumeration and Control Protocol (AECP) AA handlers */
//typedef void(LA_AVDECC_BINDINGS_C_CALL_CONVENTION^ avdecc_local_entity_address_access_block)(LA_AVDECC_LOCAL_ENTITY_HANDLE const /*handle*/, avdecc_unique_identifier_t const /*entityID*/, avdecc_local_entity_aa_command_status_t const /*status*/, avdecc_entity_address_access_tlvs_cp const /*tlvs*/);
///* Enumeration and Control Protocol (AECP) MVU handlers (Milan Vendor Unique) */
typedef void(LA_AVDECC_BINDINGS_C_CALL_CONVENTION^ avdecc_local_entity_get_milan_info_block)(LA_AVDECC_LOCAL_ENTITY_HANDLE const /*handle*/, avdecc_unique_identifier_t const /*entityID*/, avdecc_local_entity_mvu_command_status_t const /*status*/, avdecc_entity_model_milan_info_cp const /*info*/);
///* Connection Management Protocol (ACMP) handlers */
typedef void(LA_AVDECC_BINDINGS_C_CALL_CONVENTION^ avdecc_local_entity_connect_stream_block)(LA_AVDECC_LOCAL_ENTITY_HANDLE const /*handle*/, avdecc_entity_model_stream_identification_cp const /*talkerStream*/, avdecc_entity_model_stream_identification_cp const /*listenerStream*/, unsigned short const /*connectionCount*/, avdecc_entity_connection_flags_t const /*flags*/, avdecc_local_entity_control_status_t const /*status*/);
typedef void(LA_AVDECC_BINDINGS_C_CALL_CONVENTION^ avdecc_local_entity_disconnect_stream_block)(LA_AVDECC_LOCAL_ENTITY_HANDLE const /*handle*/, avdecc_entity_model_stream_identification_cp const /*talkerStream*/, avdecc_entity_model_stream_identification_cp const /*listenerStream*/, unsigned short const /*connectionCount*/, avdecc_entity_connection_flags_t const /*flags*/, avdecc_local_entity_control_status_t const /*status*/);
typedef void(LA_AVDECC_BINDINGS_C_CALL_CONVENTION^ avdecc_local_entity_disconnect_talker_stream_block)(LA_AVDECC_LOCAL_ENTITY_HANDLE const /*handle*/, avdecc_entity_model_stream_identification_cp const /*talkerStream*/, avdecc_entity_model_stream_identification_cp const /*listenerStream*/, unsigned short const /*connectionCount*/, avdecc_entity_connection_flags_t const /*flags*/, avdecc_local_entity_control_status_t const /*status*/);
typedef void(LA_AVDECC_BINDINGS_C_CALL_CONVENTION^ avdecc_local_entity_get_talker_stream_state_block)(LA_AVDECC_LOCAL_ENTITY_HANDLE const /*handle*/, avdecc_entity_model_stream_identification_cp const /*talkerStream*/, avdecc_entity_model_stream_identification_cp const /*listenerStream*/, unsigned short const /*connectionCount*/, avdecc_entity_connection_flags_t const /*flags*/, avdecc_local_entity_control_status_t const /*status*/);
typedef void(LA_AVDECC_BINDINGS_C_CALL_CONVENTION^ avdecc_local_entity_get_listener_stream_state_block)(LA_AVDECC_LOCAL_ENTITY_HANDLE const /*handle*/, avdecc_entity_model_stream_identification_cp const /*talkerStream*/, avdecc_entity_model_stream_identification_cp const /*listenerStream*/, unsigned short const /*connectionCount*/, avdecc_entity_connection_flags_t const /*flags*/, avdecc_local_entity_control_status_t const /*status*/);
typedef void(LA_AVDECC_BINDINGS_C_CALL_CONVENTION^ avdecc_local_entity_get_talker_stream_connection_block)(LA_AVDECC_LOCAL_ENTITY_HANDLE const /*handle*/, avdecc_entity_model_stream_identification_cp const /*talkerStream*/, avdecc_entity_model_stream_identification_cp const /*listenerStream*/, unsigned short const /*connectionCount*/, avdecc_entity_connection_flags_t const /*flags*/, avdecc_local_entity_control_status_t const /*status*/);
#endif /* __BLOCKS__ */
...
LA_AVDECC_BINDINGS_C_API avdecc_local_entity_error_t LA_AVDECC_BINDINGS_C_CALL_CONVENTION LA_AVDECC_LocalEntity_queryEntityAvailable_block(LA_AVDECC_LOCAL_ENTITY_HANDLE const handle, avdecc_unique_identifier_t const entityID, avdecc_local_entity_query_entity_available_block const onResult);
LA_AVDECC_BINDINGS_C_API avdecc_local_entity_error_t LA_AVDECC_BINDINGS_C_CALL_CONVENTION LA_AVDECC_LocalEntity_queryControllerAvailable_block(LA_AVDECC_LOCAL_ENTITY_HANDLE const handle, avdecc_unique_identifier_t const entityID, avdecc_local_entity_query_controller_available_block const onResult);
LA_AVDECC_BINDINGS_C_API avdecc_local_entity_error_t LA_AVDECC_BINDINGS_C_CALL_CONVENTION LA_AVDECC_LocalEntity_registerUnsolicitedNotifications_block(LA_AVDECC_LOCAL_ENTITY_HANDLE const handle, avdecc_unique_identifier_t const entityID, avdecc_local_entity_register_unsolicited_notifications_block const onResult);
...
LA_AVDECC_BINDINGS_C_API avdecc_local_entity_error_t LA_AVDECC_BINDINGS_C_CALL_CONVENTION LA_AVDECC_LocalEntity_readEntityDescriptor_block(LA_AVDECC_LOCAL_ENTITY_HANDLE const handle, avdecc_unique_identifier_t const entityID, avdecc_local_entity_read_entity_descriptor_block const onResult);
LA_AVDECC_BINDINGS_C_API avdecc_local_entity_error_t LA_AVDECC_BINDINGS_C_CALL_CONVENTION LA_AVDECC_LocalEntity_readConfigurationDescriptor_block(LA_AVDECC_LOCAL_ENTITY_HANDLE const handle, avdecc_unique_identifier_t const entityID, avdecc_entity_model_descriptor_type_t const configurationIndex, avdecc_local_entity_read_configuration_descriptor_block const onResult);
LA_AVDECC_BINDINGS_C_API avdecc_local_entity_error_t LA_AVDECC_BINDINGS_C_CALL_CONVENTION LA_AVDECC_LocalEntity_readAudioUnitDescriptor_block(LA_AVDECC_LOCAL_ENTITY_HANDLE const handle, avdecc_unique_identifier_t const entityID, avdecc_entity_model_descriptor_type_t const configurationIndex, avdecc_entity_model_descriptor_type_t const audioUnitIndex, avdecc_local_entity_read_audio_unit_descriptor_block const onResult);
LA_AVDECC_BINDINGS_C_API avdecc_local_entity_error_t LA_AVDECC_BINDINGS_C_CALL_CONVENTION LA_AVDECC_LocalEntity_readStreamInputDescriptor_block(LA_AVDECC_LOCAL_ENTITY_HANDLE const handle, avdecc_unique_identifier_t const entityID, avdecc_entity_model_descriptor_type_t const configurationIndex, avdecc_entity_model_descriptor_type_t const streamIndex, avdecc_local_entity_read_stream_input_descriptor_block const onResult);
LA_AVDECC_BINDINGS_C_API avdecc_local_entity_error_t LA_AVDECC_BINDINGS_C_CALL_CONVENTION LA_AVDECC_LocalEntity_readStreamOutputDescriptor_block(LA_AVDECC_LOCAL_ENTITY_HANDLE const handle, avdecc_unique_identifier_t const entityID, avdecc_entity_model_descriptor_type_t const configurationIndex, avdecc_entity_model_descriptor_type_t const streamIndex, avdecc_local_entity_read_stream_output_descriptor_block const onResult);
...
LA_AVDECC_BINDINGS_C_API avdecc_local_entity_error_t LA_AVDECC_BINDINGS_C_CALL_CONVENTION LA_AVDECC_LocalEntity_readAvbInterfaceDescriptor_block(LA_AVDECC_LOCAL_ENTITY_HANDLE const handle, avdecc_unique_identifier_t const entityID, avdecc_entity_model_descriptor_type_t const configurationIndex, avdecc_entity_model_descriptor_type_t const avbInterfaceIndex, avdecc_local_entity_read_avb_interface_descriptor_block const onResult);
...
LA_AVDECC_BINDINGS_C_API avdecc_local_entity_error_t LA_AVDECC_BINDINGS_C_CALL_CONVENTION LA_AVDECC_LocalEntity_readAudioClusterDescriptor_block(LA_AVDECC_LOCAL_ENTITY_HANDLE const handle, avdecc_unique_identifier_t const entityID, avdecc_entity_model_descriptor_type_t const configurationIndex, avdecc_entity_model_descriptor_type_t const clusterIndex, avdecc_local_entity_read_audio_cluster_descriptor_block const onResult);
...
LA_AVDECC_BINDINGS_C_API avdecc_local_entity_error_t LA_AVDECC_BINDINGS_C_CALL_CONVENTION LA_AVDECC_LocalEntity_readClockDomainDescriptor_block(LA_AVDECC_LOCAL_ENTITY_HANDLE const handle, avdecc_unique_identifier_t const entityID, avdecc_entity_model_descriptor_type_t const configurationIndex, avdecc_entity_model_descriptor_type_t const clockDomainIndex, avdecc_local_entity_read_clock_domain_descriptor_block const onResult);
...
LA_AVDECC_BINDINGS_C_API avdecc_local_entity_error_t LA_AVDECC_BINDINGS_C_CALL_CONVENTION LA_AVDECC_LocalEntity_getStreamInputInfo_block(LA_AVDECC_LOCAL_ENTITY_HANDLE const handle, avdecc_unique_identifier_t const entityID, avdecc_entity_model_descriptor_type_t const streamIndex, avdecc_local_entity_get_stream_input_info_block const onResult);
LA_AVDECC_BINDINGS_C_API avdecc_local_entity_error_t LA_AVDECC_BINDINGS_C_CALL_CONVENTION LA_AVDECC_LocalEntity_getStreamOutputInfo_block(LA_AVDECC_LOCAL_ENTITY_HANDLE const handle, avdecc_unique_identifier_t const entityID, avdecc_entity_model_descriptor_type_t const streamIndex, avdecc_local_entity_get_stream_output_info_block const onResult);
LA_AVDECC_BINDINGS_C_API avdecc_local_entity_error_t LA_AVDECC_BINDINGS_C_CALL_CONVENTION LA_AVDECC_LocalEntity_setEntityName_block(LA_AVDECC_LOCAL_ENTITY_HANDLE const handle, avdecc_unique_identifier_t const entityID, avdecc_fixed_string_t const entityName, avdecc_local_entity_set_entity_name_block const onResult);
LA_AVDECC_BINDINGS_C_API avdecc_local_entity_error_t LA_AVDECC_BINDINGS_C_CALL_CONVENTION LA_AVDECC_LocalEntity_getEntityName_block(LA_AVDECC_LOCAL_ENTITY_HANDLE const handle, avdecc_unique_identifier_t const entityID, avdecc_local_entity_get_entity_name_block const onResult);
...
LA_AVDECC_BINDINGS_C_API avdecc_local_entity_error_t LA_AVDECC_BINDINGS_C_CALL_CONVENTION LA_AVDECC_LocalEntity_getEntityGroupName_block(LA_AVDECC_LOCAL_ENTITY_HANDLE const handle, avdecc_unique_identifier_t const entityID, avdecc_local_entity_get_entity_group_name_block const onResult);
LA_AVDECC_BINDINGS_C_API avdecc_local_entity_error_t LA_AVDECC_BINDINGS_C_CALL_CONVENTION LA_AVDECC_LocalEntity_setConfigurationName_block(LA_AVDECC_LOCAL_ENTITY_HANDLE const handle, avdecc_unique_identifier_t const entityID, avdecc_entity_model_descriptor_type_t const configurationIndex, avdecc_fixed_string_t const configurationName, avdecc_local_entity_set_configuration_name_block const onResult);
LA_AVDECC_BINDINGS_C_API avdecc_local_entity_error_t LA_AVDECC_BINDINGS_C_CALL_CONVENTION LA_AVDECC_LocalEntity_getConfigurationName_block(LA_AVDECC_LOCAL_ENTITY_HANDLE const handle, avdecc_unique_identifier_t const entityID, avdecc_entity_model_descriptor_type_t const configurationIndex, avdecc_local_entity_get_configuration_name_block const onResult);
LA_AVDECC_BINDINGS_C_API avdecc_local_entity_error_t LA_AVDECC_BINDINGS_C_CALL_CONVENTION LA_AVDECC_LocalEntity_setAudioUnitName_block(LA_AVDECC_LOCAL_ENTITY_HANDLE const handle, avdecc_unique_identifier_t const entityID, avdecc_entity_model_descriptor_type_t const configurationIndex, avdecc_entity_model_descriptor_type_t const audioUnitIndex, avdecc_fixed_string_t const audioUnitName, avdecc_local_entity_set_audio_unit_name_block const onResult);
...
LA_AVDECC_BINDINGS_C_API avdecc_local_entity_error_t LA_AVDECC_BINDINGS_C_CALL_CONVENTION LA_AVDECC_LocalEntity_setStreamInputName_block(LA_AVDECC_LOCAL_ENTITY_HANDLE const handle, avdecc_unique_identifier_t const entityID, avdecc_entity_model_descriptor_type_t const configurationIndex, avdecc_entity_model_descriptor_type_t const streamIndex, avdecc_fixed_string_t const streamInputName, avdecc_local_entity_set_stream_input_name_block const onResult);
...
LA_AVDECC_BINDINGS_C_API avdecc_local_entity_error_t LA_AVDECC_BINDINGS_C_CALL_CONVENTION LA_AVDECC_LocalEntity_getEntityCounters_block(LA_AVDECC_LOCAL_ENTITY_HANDLE const handle, avdecc_unique_identifier_t const entityID, avdecc_local_entity_get_entity_counters_block const onResult);
...
LA_AVDECC_BINDINGS_C_API avdecc_local_entity_error_t LA_AVDECC_BINDINGS_C_CALL_CONVENTION LA_AVDECC_LocalEntity_getStreamInputCounters_block(LA_AVDECC_LOCAL_ENTITY_HANDLE const handle, avdecc_unique_identifier_t const entityID, avdecc_entity_model_descriptor_type_t const streamIndex, avdecc_local_entity_get_stream_input_counters_block const onResult);
LA_AVDECC_BINDINGS_C_API avdecc_local_entity_error_t LA_AVDECC_BINDINGS_C_CALL_CONVENTION LA_AVDECC_LocalEntity_getStreamOutputCounters_block(LA_AVDECC_LOCAL_ENTITY_HANDLE const handle, avdecc_unique_identifier_t const entityID, avdecc_entity_model_descriptor_type_t const streamIndex, avdecc_local_entity_get_stream_output_counters_block const onResult);
//LA_AVDECC_BINDINGS_C_API avdecc_local_entity_error_t LA_AVDECC_BINDINGS_C_CALL_CONVENTION LA_AVDECC_LocalEntity_startOperation_block(LA_AVDECC_LOCAL_ENTITY_HANDLE const handle, avdecc_unique_identifier_t const entityID, model::DescriptorType const descriptorType, model::DescriptorIndex const descriptorIndex, model::MemoryObjectOperationType const operationType, MemoryBuffer const& memoryBuffer, StartOperationHandler const onResult);
//LA_AVDECC_BINDINGS_C_API avdecc_local_entity_error_t LA_AVDECC_BINDINGS_C_CALL_CONVENTION LA_AVDECC_LocalEntity_abortOperation_block(LA_AVDECC_LOCAL_ENTITY_HANDLE const handle, avdecc_unique_identifier_t const entityID, model::DescriptorType const descriptorType, model::DescriptorIndex const descriptorIndex, model::OperationID const operationID, AbortOperationHandler const onResult);
//LA_AVDECC_BINDINGS_C_API avdecc_local_entity_error_t LA_AVDECC_BINDINGS_C_CALL_CONVENTION LA_AVDECC_LocalEntity_setMemoryObjectLength_block(LA_AVDECC_LOCAL_ENTITY_HANDLE const handle, avdecc_unique_identifier_t const entityID, avdecc_entity_model_descriptor_type_t const configurationIndex, avdecc_entity_model_descriptor_type_t const memoryObjectIndex, unsigned long long const length, SetMemoryObjectLengthHandler const onResult);
//LA_AVDECC_BINDINGS_C_API avdecc_local_entity_error_t LA_AVDECC_BINDINGS_C_CALL_CONVENTION LA_AVDECC_LocalEntity_getMemoryObjectLength_block(LA_AVDECC_LOCAL_ENTITY_HANDLE const handle, avdecc_unique_identifier_t const entityID, avdecc_entity_model_descriptor_type_t const configurationIndex, avdecc_entity_model_descriptor_type_t const memoryObjectIndex, GetMemoryObjectLengthHandler const onResult);

/* Enumeration and Control Protocol (AECP) AA */
//LA_AVDECC_BINDINGS_C_API avdecc_local_entity_error_t LA_AVDECC_BINDINGS_C_CALL_CONVENTION LA_AVDECC_LocalEntity_addressAccess_block(LA_AVDECC_LOCAL_ENTITY_HANDLE const handle, avdecc_unique_identifier_t const entityID, addressAccess::Tlvs const& tlvs, avdecc_local_entity_address_access_block const onResult);

/* Enumeration and Control Protocol (AECP) MVU (Milan Vendor Unique) */
LA_AVDECC_BINDINGS_C_API avdecc_local_entity_error_t LA_AVDECC_BINDINGS_C_CALL_CONVENTION LA_AVDECC_LocalEntity_getMilanInfo_block(LA_AVDECC_LOCAL_ENTITY_HANDLE const handle, avdecc_unique_identifier_t const entityID, avdecc_local_entity_get_milan_info_block const onResult);

/* Connection Management Protocol (ACMP) */
LA_AVDECC_BINDINGS_C_API avdecc_local_entity_error_t LA_AVDECC_BINDINGS_C_CALL_CONVENTION LA_AVDECC_LocalEntity_connectStream_block(LA_AVDECC_LOCAL_ENTITY_HANDLE const handle, avdecc_entity_model_stream_identification_cp const talkerStream, avdecc_entity_model_stream_identification_cp const listenerStream, avdecc_local_entity_connect_stream_block const onResult);
...
LA_AVDECC_BINDINGS_C_API avdecc_local_entity_error_t LA_AVDECC_BINDINGS_C_CALL_CONVENTION LA_AVDECC_LocalEntity_getTalkerStreamState_block(LA_AVDECC_LOCAL_ENTITY_HANDLE const handle, avdecc_entity_model_stream_identification_cp const talkerStream, avdecc_local_entity_get_talker_stream_state_block const onResult);
...
LA_AVDECC_BINDINGS_C_API avdecc_local_entity_error_t LA_AVDECC_BINDINGS_C_CALL_CONVENTION LA_AVDECC_LocalEntity_getTalkerStreamConnection_block(LA_AVDECC_LOCAL_ENTITY_HANDLE const handle, avdecc_entity_model_stream_identification_cp const talkerStream, unsigned short const connectionIndex, avdecc_local_entity_get_talker_stream_connection_block const onResult);
#endif
