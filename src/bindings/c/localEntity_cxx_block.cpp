...
#if 0
typedef void
(^avdecc_local_entity_acquireEntity_Block)(
        const la::avdecc::entity::controller::Interface *const,
        const la::avdecc::UniqueIdentifier,
        const la::avdecc::entity::LocalEntity::AemCommandStatus,
        const la::avdecc::UniqueIdentifier,
        const la::avdecc::entity::model::DescriptorType,
        const la::avdecc::entity::model::DescriptorIndex
);
#endif

LA_AVDECC_BINDINGS_C_API avdecc_local_entity_error_t
LA_AVDECC_BINDINGS_C_CALL_CONVENTION LA_AVDECC_LocalEntity_invokeWithObject(LA_AVDECC_LOCAL_ENTITY_HANDLE const handle,
	std::function<void(la::avdecc::entity::AggregateEntity &)> const &handler)
{
        try
        {
...
#if 0 // {
LA_AVDECC_BINDINGS_C_API avdecc_local_entity_error_t
LA_AVDECC_BINDINGS_C_CALL_CONVENTION LA_AVDECC_LocalEntity_acquireEntity_Block(LA_AVDECC_LOCAL_ENTITY_HANDLE const handle,
    ...
    avdecc_local_entity_acquireEntity_Block onResultBlock)
{
	return LA_AVDECC_LocalEntity_invokeWithObject(handle, [entityID, isPersistent, descriptorType, descriptorIndex, onResultBlock](la::avdecc::entity::AggregateEntity &obj) {
			obj.acquireEntity(entityID, isPersistent, descriptorType, descriptorIndex, onResultBlock);
		});
}
